...
(function initShopScoutGridCodexState(root) {
  ...
  function deserialize(blob) {
    ...
    return {
      ...
      priceDisplayMode: input.priceDisplayMode === 'actual' ? 'actual' : 'rounded',
      measurementDisplayMode: input.measurementDisplayMode === 'rounded' ? 'rounded' : 'actual',
