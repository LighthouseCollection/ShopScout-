...
assert.ok(/\.rb-office-ribbon\s+\.rb-group\[data-group-id="list"\]\s+>\s+\.rb-group-content\s*{[\s\S]{0,220}grid-template-rows:\s*auto auto;/.test(ribbonCss),
  'List group (all tabs) stacks the select over the action row');
